...
public class CuartoIntento {

    public static void main(String[] args) {
        ProductosAlimentarios listaProductosAlimentarios[] = new ProductosAlimentarios[5];
        listaProductosAlimentarios[0] = new ProductosAlimentarios();
        listaProductosAlimentarios[1] = new Bebidas(200.0, 10, 'n');
        listaProductosAlimentarios[2] = new Refrigerados(140.0, 20);
        listaProductosAlimentarios[3] = new Bebidas(120.0, 10, 'I');
        listaProductosAlimentarios[4] = new Refrigerados(110.0, 7);
        PrecioTotal solucion1 = new PrecioTotal(listaProductosAlimentarios);
